...
# $t6 - tmp
	...
	.data
str1:	.asciiz	"Intrroduza 2 numero(ate 16 bit):"
...
main:	li	$t4,0			# res = 0
	...
	andi	$t2,$t0,0xFFFF		# mdor = v1 & 0x0F 
	andi	$t3,$t1,0xFFFF		# mdo = v2  & 0x0F
	# para numeros ate 16 bit o maior pode ser 65535 = 0xFFFF
	
while:	beq	$t2,0,endw		# while mdor =! 0
	addi	$t5,$t5,1		# i++
	bge	$t5,17,endw		# while i++ < 4
